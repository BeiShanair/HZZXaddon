...
public class Aircondition extends HorizontalBlock {
    public Aircondition(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(1, 0, 3, 15, 32, 13)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(3, 0, 1, 13, 32, 15)).get();
