...
public class BlackBoard2 extends HorizontalBlock {
    public BlackBoard2(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(0, -16, 12, 16, 32, 16)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(12, -16, 0, 16, 32, 16)).get();
    private static final VoxelShape SHAPE_S = java.util.Optional.of(
            Block.makeCuboidShape(0, -16, 0, 16, 32, 4)).get();
    private static final VoxelShape SHAPE_E = java.util.Optional.of(
            Block.makeCuboidShape(0, -16, 0, 4, 32, 16)).get();
