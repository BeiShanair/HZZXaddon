...
public class Enclosure extends HorizontalBlock {
    public Enclosure(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(-16, 0, 7, 32, 32, 9)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(7, 0, -16, 9, 32, 32)).get();
