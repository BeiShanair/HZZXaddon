...
public class ComputerChair extends HorizontalBlock {
    public ComputerChair(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(2, 0, 4, 14, 10, 12)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(4, 0, 2, 12, 10, 14)).get();
