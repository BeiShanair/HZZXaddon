...
public class FrontLight extends HorizontalBlock {
    public FrontLight(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(-16, -4, 4, 32, 16, 12)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(4, -4, -16, 12, 16, 32)).get();
