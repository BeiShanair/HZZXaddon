...
public class ComputerDesk extends HorizontalBlock {
    public ComputerDesk(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(-16, 0, 0, 16, 16, 15)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(0, 0, 0, 15, 16, 32)).get();
    private static final VoxelShape SHAPE_S = java.util.Optional.of(
            Block.makeCuboidShape(0, 0, 1, 32, 16, 16)).get();
    private static final VoxelShape SHAPE_E = java.util.Optional.of(
            Block.makeCuboidShape(1, 0, -16, 16, 16, 16)).get();
