...
public class Light extends HorizontalBlock {
    public Light(Properties properties) {
        super(properties);
    }

    private static final VoxelShape SHAPE_N = java.util.Optional.of(
            Block.makeCuboidShape(-16, -3, 0, 32, 16, 16)).get();
    private static final VoxelShape SHAPE_W = java.util.Optional.of(
            Block.makeCuboidShape(0, -3, -16, 16, 16, 32)).get();
